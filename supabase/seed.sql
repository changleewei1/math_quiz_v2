-- 插入章節
INSERT INTO chapters (id, title, sort_order, is_active) VALUES
    ('3-1', '一元一次式化簡', 1, true),
    ('3-2', '一元一次方程式計算', 2, true),
    ('3-3', '一元一次方程式應用問題', 3, true)
...
-- 刪除舊的題型資料（以便重新插入）
DELETE FROM question_types WHERE chapter_id IN ('3-1', '3-2', '3-3');
